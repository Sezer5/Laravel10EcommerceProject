            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- form start -->
                        <form role="form" action="{{route('admin.sliders.update',['id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">First Title</label>
                                    <input type="text" name="firsttitle" class="form-control" placeholder="Enter title" value="{{$data->firsttitle}}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Second Title</label>
                                    <input type="text" name="secondtitle" class="form-control" placeholder="Enter title" value="{{$data->secondtitle}}">
                                </div>
                                <div class="form-group">
