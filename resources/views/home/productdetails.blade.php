                    ...
                    <div class="product-details"><!--product-details-->
                        <div class="col-sm-5">
                            ...
                            <div id="similar-product" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    @foreach($product_gallery as $rs)
                                    <div class="item active">
                                        <a href=""><img src="{{Storage::url($rs->image)}}" style="width:80px"></a>
                        ...
                        <div class="col-sm-7">
                            <div class="product-information"><!--/product-information-->
                                ...
                                <p><b>Category:</b> {{ \App\Http\Controllers\HomeController::getParentsTree($products->category, $products->category->title) }}</p>
